...
import {removeSeat, addSeat} from '../actions'
...
class SeatSelector extends Component {
    ...
    drawSelectSeat = () => {
        ...
        for (let i = 0; i <= selectSeat.length - 1; i++) {
    ...
    render() {
        return (
            <canvas style={{ width: CANVAS_WIDTH, height: CANVAS_HEIGHT }} onClick={this.clickSeat} ref="canvas" width={DRAW_CANVAS_WIDTH} height={DRAW_CANVAS_HEIGHT} />
        )
    }
